...
func (pconn *persistConn) addTLS(name string, trace *httptrace.ClientTrace) error {
	...
	tlsConn := gmtls.Client( plainConn,cfg )
	...
	pcs := &cs
	if trace != nil && trace.TLSHandshakeDone != nil {
		ppcs := (*tls.ConnectionState)(unsafe.Pointer(pcs))
		trace.TLSHandshakeDone(*ppcs, nil)
	}
	pconn.tlsState = (*tls.ConnectionState)(unsafe.Pointer(pcs))
	pconn.conn = tlsConn
	return nil
}
